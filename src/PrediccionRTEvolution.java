 ...
 */
public class PrediccionRTEvolution {
    ...
    public static void main(String[] args) {
        try {
            ...
            PrintWriter writer = new PrintWriter("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/resultadosRTEvolution" + ".txt");
