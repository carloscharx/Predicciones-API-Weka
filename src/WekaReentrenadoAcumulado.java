 ...
 */
public class WekaReentrenadoAcumulado {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            int training =288;
            int test = 288;
            PrintWriter tiempos = new PrintWriter("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/resultadosReentrenadoAcumuladoTiemposMAE" +".txt");
            for(int i = 0;i<algorithms_num;i++) {
                PrintWriter writer = new PrintWriter("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/resultadosReentrenadosAcumulados" + algoritmos[i] + ".txt");
                ...
                for (int j = 0; j < links_num; j++) {
                    ...
                    for(int it=0;it<6;it++){
                        Instances training_set = new Instances(data_set,0,training*(it+1));
