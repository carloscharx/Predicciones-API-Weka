 ...
 */
public class WekaReentrenadoComparativa {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PrintWriter tiempos = new PrintWriter("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/resultadosReentrenadoComparativa1diaTiemposMAE" +".txt");
            for(int i = 0;i<algorithms_num;i++) {
                PrintWriter writer = new PrintWriter("C:/Users/carloscharx/Documentos/Teleco/4º Teleco/Prácticas y TFG/datos-Funkfeuer-CONFINE/resultadosReentrenadoComparativa1dia" + algoritmos[i] + ".txt");
